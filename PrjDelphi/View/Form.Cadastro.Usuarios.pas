...
begin
  ...
  NomeUsuario:= ControllerUsuario.GetNomeUsuario(edtCodUsuario.Text);
...
begin
  edtNomeUsuario.Text:= ControllerUsuario.GetNomeUsuario(edtCodUsuario.Text);
end;
...
begin
  Application.CreateForm(TControllerUsuario, ControllerUsuario);
end;
